  ...
  return (
    <section className="space-y-5">
      <header className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
        <h1 className="text-xl font-semibold">People and HRIS</h1>
        <p className="mt-2 text-sm text-slate-600">Manage directory records, complete HR profiles, and create employment engagements.</p>
      </header>

      <div className="grid gap-5 xl:grid-cols-[0.85fr_1.15fr]">
        <article className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
          <h2 className="text-lg font-semibold">Create Person</h2>
          <p className="mt-1 text-sm text-slate-600">Start a record, then complete full HR profile details.</p>

          <form className="mt-4 grid gap-3" onSubmit={onCreatePerson}>
          ...
          <h3 className="text-sm font-semibold text-slate-900">Create Engagement</h3>
          <form className="mt-3 grid gap-3" onSubmit={onCreateEngagement}>
            <label className="space-y-1 text-xs font-medium uppercase tracking-wide text-slate-500">
              <span>Person</span>
        ...
        <article className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
          ...
          {!selectedPerson ? (
            ...
            <form key={selectedPerson.id} className="mt-5 grid gap-4" onSubmit={onUpdateSelectedPerson}>
